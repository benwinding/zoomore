  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <h1>Privacy Policy of Zoomore</h1>
        <p>Ben Winding operates the zoomore.benwinding.com website, and the Zoomore app (henceforth known as Service), found in the App Store and the Google Play store.</p>
        <p>This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service, the Zoomore website or app.</p>
        <p>If you choose to use our Service, then you agree to the collection and use of information in relation with this policy. The Personal Information that we collect are used for providing and improving the Service. We will not use or share your information with anyone except as described in this Privacy Policy.</p>
        <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at zoomore.benwinding.com, unless otherwise defined in this Privacy Policy.</p>
